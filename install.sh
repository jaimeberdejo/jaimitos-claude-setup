...
echo "  2. Point the ENFORCED gate at your sensitive paths: edit HIGH_STAKES_RE in"
echo "     .claude/lib/_high-stakes.sh (this is what tick.sh actually enforces). The"
echo "     'paths:' list in .claude/rules/high-stakes.md is an advisory human mirror —"
echo "     editing ONLY that file does NOT change enforcement."
